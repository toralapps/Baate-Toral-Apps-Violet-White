package com.playerstudio.redpink.videocall.chat.activitys
...
import com.playerstudio.redpink.videocall.chat.adapter.FlagsAdapter
import com.playerstudio.redpink.videocall.chat.extenstionfunctions.snackBar
import com.playerstudio.redpink.videocall.chat.livevideocall.activity.ConnectLiveActivity
import com.playerstudio.redpink.videocall.chat.repository.Response
import com.playerstudio.redpink.videocall.chat.videolistmodel.Falgs
import com.playerstudio.redpink.videocall.chat.videolistmodel.SavedVideoList
import com.playerstudio.redpink.videocall.chat.videolistmodel.VideoList
import com.playerstudio.redpink.videocall.chat.viewmodels.MainViewModel
...
class LocationActivity : NewAddsActivty(), FlagsAdapter.Interaction {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val flags = listOf<Falgs>(
            Falgs(R.drawable.category_2,"Canadian girl call"),
            Falgs(R.drawable.category_3,"Indian girl call"),
            Falgs(R.drawable.category_4,"Russian girl call"),
            Falgs(R.drawable.category_5,"American girl call"),
           Falgs(R.drawable.collage_1,"Korean girl call")
        )
