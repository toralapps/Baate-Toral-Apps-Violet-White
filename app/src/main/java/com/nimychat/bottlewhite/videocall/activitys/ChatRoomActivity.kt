...
import com.nimychat.bottlewhite.videocall.adapter.VideoListAdapter
import com.nimychat.bottlewhite.videocall.blockuser.BlockListActivity
import com.nimychat.bottlewhite.videocall.extenstionfunctions.snackBar
import com.nimychat.bottlewhite.videocall.networkmanager.ConnectionLiveData
        ...
        video?.let { videoList ->
            ...
            if (videoList.Data.isNotEmpty()) {
                ...
                if (videoCallType == "Cache"){
                    videoCallType =  com.nimychat.bottlewhite.videocall.videolistmodel.SavedVideoList.getVideos(this)?.let {
