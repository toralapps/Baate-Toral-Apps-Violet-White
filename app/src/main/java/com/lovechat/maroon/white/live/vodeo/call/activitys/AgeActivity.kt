...
import com.lovechat.maroon.white.live.vodeo.call.livevideocall.util.CodeDecrypt
...
class AgeActivity : NewAddsActivty() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
                ...
                adsViewModel.adsState.collect{adsState ->
                    when(adsState){
                        ...
                        is AdsState.AdClosed ->{
                           Intent(this@AgeActivity, LocationActivity::class.java).apply {
                               startActivity(this)
                           }
                        }
        ...
        loading_icon.setOnClickListener {
