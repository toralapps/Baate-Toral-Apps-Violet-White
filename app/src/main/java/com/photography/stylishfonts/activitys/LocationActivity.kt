...
import com.photography.stylishfonts.adapter.FlagsAdapter
import com.photography.stylishfonts.videolistmodel.Falgs
...
class LocationActivity : AppCompatActivity(), FlagsAdapter.Interaction {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val flags = listOf<Falgs>(
            Falgs(R.drawable.collage_6,"Collage girl call"),
            Falgs(R.drawable.collage_7,"Party girl call"),
            Falgs(R.drawable.collage_8,"Naughty girl call"),
            Falgs(R.drawable.collage_9,"Abla girl call"),
